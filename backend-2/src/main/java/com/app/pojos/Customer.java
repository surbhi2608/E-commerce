...
public class Customer extends BaseEntity {
	...
	@NotBlank(message="Password No can't be blank!")
	...
	public Customer(@NotBlank(message = "First name can't be blank!") String firstName,
			@NotBlank(message = "Last name can't be blank!") String lastName,
			@Length(min = 10, max = 10, message = "Mobile No must be of 10 digits only!") @NotBlank(message = "Mobile No can't be blank!") String mobileNo,
	...
	public Customer() {
		super();
		System.out.println("Customer def constructor");
	}
	...
	public String toString() {
		return "Customer [firstName=" + firstName + ", lastName=" + lastName + ", mobileNo=" + mobileNo + ", email="
				+ email + "]";
	}
