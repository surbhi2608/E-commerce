...
class EditVendorCatalogueComponent extends Component{
    ...
    loadBook(){
        ...
        CatalogueService.fetchBookById(window.localStorage.getItem("bookId"))
        .then((res) => {
            ...
            this.setState({
                ...
                format: book.format, 
                langPublished: book.langPublished, 
        ...
        console.log("check : "+this.state.bName);
    }
    ...
    saveBook = (e) => {
        ...
        let book = {id: this.state.id, bName: this.state.bName, category: this.state.category, 
            format: this.state.format, langPublished: this.state.langPublished, 
            manufacturer: this.state.manufacturer, author: this.state.author, status: this.state.status, 
            publicationYear: this.state.publicationYear, mrp: this.state.mrp, 
            offer: this.state.offer, quantity: this.state.quantity, description: this.state.description, vendor:{id: vendorId}};
        
            CatalogueService.editBook(book)
            .then(res => {
                this.setState({message : 'Book edited successfully.'});
                console.log("Done editing book!");
...
export default EditVendorCatalogueComponent;
